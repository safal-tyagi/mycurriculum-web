...
const Home = () => {
  ...
  const courseExists = filteredCourses?.some(course => course.name === selectedCourse && course.level === selectedLevel);
  ...
  return (
    <Container>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select size='small' value={selectedCategory} onChange={(e) => dispatch(setSelectedCategory(e.target.value))}>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select size='small' value={selectedCourse} onChange={(e) => dispatch(setSelectedCourse(e.target.value))}>
            <MenuItem value="">None</MenuItem>
            {courses.map(course => (
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select size='small' value={selectedLevel} onChange={(e) => dispatch(setSelectedLevel(e.target.value))}>
            <MenuItem value="">None</MenuItem>
            {levels.map(level => (
        ...
        {!courseExists && (
        <Button variant="contained" color="primary" onClick={handleFetchCourse} disabled={!selectedCourse || !selectedLevel}>
          Generate Course
        </Button>
      )}
